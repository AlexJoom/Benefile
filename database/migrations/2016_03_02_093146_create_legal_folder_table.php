...
class CreateLegalFolderTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('legal_section_options_lookup', function(Blueprint $table){
            $table->increments('id');
            $table->string('description');
        });
        ...
        Schema::create('legal_section_status', function(Blueprint $table){
            ...
            $table->integer('legal_folder_id')->unsigned();
            $table->foreign('legal_option_id')->references('id')->on('legal_section_options_lookup');
    ...
    public function down()
    {
        ...
        Schema::drop('legal_section_options_lookup');
